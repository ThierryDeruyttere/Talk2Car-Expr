...
def parse_opt():
    ...
    parser.add_argument('--lm_margin_same_cat', type=float, default=0.2, help="M1 margin")
    parser.add_argument('--lm_margin_wrong_cat', type=float, default=0.4, help="M2 margin")
    ...
    parser.add_argument('--talk2car_root', default='/cw/liir/NoCsBack/testliir/datasets/refer_expr/Talk2Car/imgs',
                        type=str)
